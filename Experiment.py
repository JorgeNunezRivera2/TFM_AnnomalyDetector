...
from Recommender import recommender_data_preparation
...
#recommender_data_preparation(original_database_path,generate_deep_features=True,download_images=True)
'''
...
#recommender_test(augmentation=True,test_set=Test_set.FULL,model_type=1)
#recommender_test(augmentation=True,test_set=Test_set.WORST,model_type=1)
#recommender_test(augmentation=True,test_set=Test_set.BALANCED,model_type=2)
#recommender_test(augmentation=False,test_set=Test_set.BALANCED,model_type=1)
#recommender_test(augmentation=True,test_set=Test_set.BALANCED,model_type=2)
#recommender_test(augmentation=True,test_set=Test_set.BALANCED,model_type=3)
